...
from pykanbanflow.api_client import ApiClient
...
class DefaultApi(object):
    ...
    def create_task(self, body, **kwargs):  # noqa: E501
        ...
        :param Task body: the new task spec (required)
    ...
    def get_all_tasks(self, **kwargs):  # noqa: E501
        """Return all tasks on a board  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_all_tasks_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_all_tasks_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[TasksByColumn]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_board(self, **kwargs):  # noqa: E501
        """Returns the structure of the board belonging to the token.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_board(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_board_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_board_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_board_with_http_info(self, **kwargs):  # noqa: E501
        """Returns the structure of the board belonging to the token.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_board_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_task_by_id(self, task_id, **kwargs):  # noqa: E501
        ...
        :param bool include_position: Include the task's position in the column/swimlane
        :return: Task
                 If the method is called asynchronously,
                 returns the request thread.
        """
